...
- [#100](https://github.com/Digilac/simap-mcp/pull/100) [`7ce1614`](https://github.com/Digilac/simap-mcp/commit/7ce161419105a9c1b70146dc630ca70b165943c8) Thanks [@mathieumaf](https://github.com/mathieumaf)! - - `src/server.ts` — migrate from the raw `@modelcontextprotocol/sdk` to [FastMCP for TypeScript](https://github.com/PrefectHQ/fastmcp-ts) (`@prefecthq/fastmcp-ts`), which now owns server construction, tool registration, and the stdio transport. Same 14 tools, same parameters, same Markdown output, still stdio-only.
...
- [#102](https://github.com/Digilac/simap-mcp/pull/102) [`b00e063`](https://github.com/Digilac/simap-mcp/commit/b00e0633dd019fcdb55fcf0a2c0aebeff0ee4248) Thanks [@mathieumaf](https://github.com/mathieumaf)! - - `README.md` — rework the installation section for non-technical users. Claude Desktop is now the recommended path with a numbered walkthrough (including the "fully quit and reopen" step and a check that the tools loaded), and the Node.js prerequisite is scoped to the clients that actually need it — Claude Desktop bundles its own runtime.
...
- [#87](https://github.com/Digilac/simap-mcp/pull/87) [`25f8d66`](https://github.com/Digilac/simap-mcp/commit/25f8d662e45480c00375598a7400b5fe0448458a) Thanks [@mathieumaf](https://github.com/mathieumaf)! - - `@modelcontextprotocol/sdk` — bump from 1.29.0 to 1.30.0. The 1.30 minor prioritizes and formats Zod issues in server-side validation errors, so malformed tool input now produces a clearer message; the rest of the release is CI/publishing changes with no runtime effect. All 14 tools are unaffected.
